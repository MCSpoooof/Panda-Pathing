...
import org.firstinspires.ftc.teamcode.pandaPathing.localization.GoBildaPinpointDriver;
...
public class PinpointLocalizer extends Localizer {
    ...
    public PinpointLocalizer(HardwareMap map, Pose setStartPose){
        ...
        odo = hardwareMap.get(GoBildaPinpointDriver.class,"cIIC2");

        //This uses mm, to use inches divide these numbers by 25.4
        odo.setOffsets(136.675, 50.5); //these are tuned for 3110-0002-0001 Product Insight #1
